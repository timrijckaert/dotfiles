...
export ZSH="/Users/timrijckaert/.oh-my-zsh"
...
# alias onelogin='java -jar $HOME/.aws/onelogin/onelogin-aws-cli.jar --profile onelogin --username tim.rijckaert@persgroep.net --appid 354709 --subdomain persgroep --region eu-west-1'

export PATH=$PATH:$ANDROID_HOME
export PATH=$PATH:$ANDROID_SDK_TOOLS
export PATH=$PATH:$ANDROID_SDK_TOOLS_BIN
export PATH=$PATH:$ANDROID_SDK_TOOLS_PLATFORM_TOOLS
